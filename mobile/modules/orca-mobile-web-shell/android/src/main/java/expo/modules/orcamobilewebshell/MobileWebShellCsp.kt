...
internal val MOBILE_WEB_SHELL_CSP = listOf(
  ...
  // untouched. What `https:` adds is a request whose target the rendered content chose, reaching
  // the sandboxed preview frame too since it inherits this policy: a document can learn it was
  // opened.
  //
